...
def fail_safe(temperature, neutrons_produced_per_second, threshold)->str:
    ...
    """
    temp_neutro = temperature * neutrons_produced_per_second
    
    if temp_neutro < 0.9 * threshold:
        reactor_status_code = 'LOW'
    elif .9 * threshold <= temp_neutro <=1.1 * threshold:
        reactor_status_code = 'NORMAL'
    else:  reactor_status_code = 'DANGER'

    return reactor_status_code 
